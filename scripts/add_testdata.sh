...
node scripts/add_reference.js -u admin -p admin -s example_settings.json -r test testdata/testdata.fasta &&\

echo "adding test annotation" &&\
node scripts/add_annotation.js -u admin -p admin -s example_settings.json -r test -t test testdata/testdata.gff 
